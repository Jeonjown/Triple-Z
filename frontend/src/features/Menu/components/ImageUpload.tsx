  ...
  return (
    <>
      <div className="items-center justify-center sm:flex sm:flex-row-reverse md:space-x-4">
        {imagePreview && (
          <div className="bg mt-4 flex-1 sm:mt-0 sm:w-1/4">
            <img
              src={imagePreview}
              alt="Image Preview"
        ...
        <label
          htmlFor="image"
          className="mt-5 flex w-full flex-1 cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 sm:mr-5 md:h-40"
        >
