...
const Story: FC = () => {
  return (
    <section className="my-10 flex w-full flex-col md:flex-row">
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-primary p-8">
        {/* Wrapper to constrain text width on large screens */}
        <div className="mx-auto max-w-xl lg:mx-0">
          {/* Header text: centered on small, left-aligned on large */}
          <h2 className="mb-4 text-center font-heading text-3xl font-bold text-white md:text-4xl lg:text-left lg:text-5xl">
          ...
          <Link to={"/about"}>
            <Button
              variant="outline"
              size="lg"
              className="mx-auto mt-10 block lg:mx-0"
            >
              About Us
            </Button>
          </Link>
