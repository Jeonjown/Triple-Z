  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        months:
          "flex flex-col space-y-4 w-full max-w-md mx-auto  justify-center",
        month: "space-y-4",
        caption: "w-full flex justify-center pt-1 relative items-center",
        caption_label: "w-full text-sm font-medium text-center",
        ...
        head_row: "flex gap-2",
        head_cell: "flex-1 text-text font-semibold font-heading text-xl",
        ...
        day_today: "bg-muted border text-text",
